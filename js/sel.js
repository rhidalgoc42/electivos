...
//if (agree)
	...
	{
		alert ("Error, falta seleccionar Plan o Electivo");
	}	
});
...
$("#opc_elect2").on("click",function(){
	var idelect2=$('input[type="radio"]:checked').val();
	document.getElementById("txtelectivo_opc").value =idelect2;
});
$("#opc_elect3").on("click",function(){
	var idelect2=$('input[type="radio"]:checked').val();
	document.getElementById("txtelectivo_opc").value =idelect2;

});
$("#opc_elect4").on("click",function(){
	var idelect2=$('input[type="radio"]:checked').val();
	document.getElementById("txtelectivo_opc").value =idelect2;
});

$("#opc_elect5").on("click",function(){
	var idelect2=$('input[type="radio"]:checked').val();
	document.getElementById("txtelectivo_opc").value =idelect2;

});
$("#opc_elect6").on("click",function(){
	var idelect2=$('input[type="radio"]:checked').val();
	document.getElementById("txtelectivo_opc").value =idelect2;

});
$("#opc_elect7").on("click",function(){
	var idelect2=$('input[type="radio"]:checked').val();
	document.getElementById("txtelectivo_opc").value =idelect2;

});
$("#opc_elect8").on("click",function(){
	var idelect2=$('input[type="radio"]:checked').val();
	document.getElementById("txtelectivo_opc").value =idelect2;
